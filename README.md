...
- O usuáiro deve receber um e-mail com instruções de recuperação de senha;
...
- A notificação deve ter um status de lida ou não-lida para que o prestador possa ter o controle;
